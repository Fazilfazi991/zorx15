        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="relative bg-card rounded-2xl p-6 border border-border/50 shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300 z-10 h-full flex flex-col">
